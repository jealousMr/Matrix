...
- 流行的分块思想，在对cache命中率进行提高

![blockchain](./img/base_lot_change.png)
...
## 模块二（以如AVX指令集，细粒度并行,three.c文件）

- 对转置矩阵进行AVX优化

![blockchain](./img/height_base_turn.png)
...
![blockchain](./img/height_lot_change.png)
...
- deal函数
![blockchain](./img/package9.png)
又是巨长的代码，要理解她还得看看下面得解析图：
![blockchain](./img/package10.png)

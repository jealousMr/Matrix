...
void deal2(double **package,int row,int col)
{
    __m256d vec_1,vec_2,vec_3,vec_4,vec_5,vec_6,vec_7,vec_8;
    __m256d a0,a1,b0,b1,b2,b3;
    vec_1=vec_2=vec_3=vec_4=vec_5=vec_6=vec_7=vec_8=_mm256_set1_pd(0);
    ...
    while (pb0!=endb0)
    {
        a0=_mm256_load_pd(pa0);
        a1=_mm256_load_pd(pa1);
        b0=_mm256_set1_pd(*(pb0++));
        b1=_mm256_set1_pd(*(pb1++));
        b2=_mm256_set1_pd(*(pb2++));
        b3=_mm256_set1_pd(*(pb3++));
    ...
    _mm256_store_pd(&C[col][row],vec_1);
    _mm256_store_pd(&C[col+1][row],vec_2);
    _mm256_store_pd(&C[col+2][row],vec_3);
    _mm256_store_pd(&C[col+3][row],vec_4);
    _mm256_store_pd(&C[col][row+4],vec_5);
    _mm256_store_pd(&C[col+1][row+4],vec_6);
    _mm256_store_pd(&C[col+2][row+4],vec_7);
    _mm256_store_pd(&C[col+3][row+4],vec_8);
